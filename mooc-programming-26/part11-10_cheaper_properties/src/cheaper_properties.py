...
def cheaper_properties(properties: list, reference: RealProperty) -> list:
    return [(p, reference.square_meters*reference.price_per_sqm - p.square_meters*p.price_per_sqm) for p in properties if p.square_meters*p.price_per_sqm < reference.square_meters*reference.price_per_sqm]
